...
| 版本 | 日期 | 内容 |
|------|------|------|
| v1.0 | 2026-06-09 | 首个正式版：角色卡放大/内联SVG兜底头像/简繁搜索兼容/exe启动修复/统计记录头像 |
| v0.9 | 2026-06-09 | 修复：exe 因 cp1252 中文字符崩溃 + 简繁搜索不兼容 + zip 打包 Unicode 文件名损坏 |
| v0.8 | 2026-06-08 | 爆裂显示优化（六边形图标、渐变色、发光效果、全爆裂支持） |
